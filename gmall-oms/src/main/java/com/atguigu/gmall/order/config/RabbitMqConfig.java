...
public class RabbitMqConfig {
    ...
    public Binding delayBinding() {
        return new Binding(ORDER_DELAY_QUEUE,
                ...
                ORDER_DELAY_EXCHANGE, ORDER_DELAY_ROUTING_KEY,
                null);
    }
    ...
    @Bean
    public Queue queue() {
        return new Queue(USER_ORDER_QUEUE, true, false, false,null);
    }


    @Bean
    public Binding deadBinding() {
        return new Binding(USER_ORDER_QUEUE,
                Binding.DestinationType.QUEUE,
                ORDER_DEAD_EXCHANGE, "order", null);
